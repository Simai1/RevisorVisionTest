...
const createToken = async (userId: number, refreshToken: string): Promise<Token> => {
...
const updateRefreshToken = async (userId: number, newRefreshToken: string): Promise<Token> => {
